...
$ ls -l php_5.6.5-1_amd64.deb
-rw-r--r-- 1 root root 6693990 Jan 31 19:56 php_5.6.5-1_amd64.deb
```
...
$ sudo dpkg -i /path/to/php_5.6.5-1_amd64.deb
```
