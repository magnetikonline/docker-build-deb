...
$ ls -l php_5.6.1-1_amd64.deb
-rw-r--r-- 1 root root 5145212 Aug 29 07:53 php_5.6.1-1_amd64.deb
```
...
$ sudo dpkg -i /path/to/php_5.6.1-1_amd64.deb
```
