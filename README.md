...
## PHP-FPM
- **OS:** Ubuntu 14.04LTS
- **Version:** 5.5.13 (PHP-FPM and CLI only)
...
$ ls -l php_5.5.13-1_amd64.deb
-rw-r--r-- 1 root root 178012 May 22 21:12 php_5.5.13-1_amd64.deb
```
...
$ sudo dpkg -i /path/to/php_5.5.13-1_amd64.deb
```
