...
$ ls -l php_5.6.9-1_amd64.deb
-rw-r--r-- 1 root root 3363622 Jun  7 13:41 php_5.6.9-1_amd64.deb
```
...
$ sudo dpkg -i /path/to/php_5.6.9-1_amd64.deb
```
